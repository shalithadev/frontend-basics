...
4. **Representation**: Resources can be represented in different formats, such as JSON, Multipart FormData or XML, with JSON being the most commonly used format.
