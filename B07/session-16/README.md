...
### 7. Admin Dashboard with Nested Routes & Dynamic Routes ✅

- Create nested routes for admin sections:
  - `/admin/movies`
  - `/admin/users`

### 8. Movie Details Page (TODO)
...
### 9. Fetching a Single Movie from the Database (TODO)
